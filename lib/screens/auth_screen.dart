...
class _AuthCardState extends State<AuthCard> {
  ...
  void _submit() async {
    ...
    try {
      ...
      } else if (error.message.contains("EMAIL_EXIST")) {
        errorMessage = "L'utilisateur existe déja";
      } else if (error.message.contains("TOO_MANY_ATTEMPTS_TRY_LATER")) {
        errorMessage = "Trop de tentatives, veuillez réésayer plutard";
      } else if (error.message.contains("INVALID_PASSWORD")) {
        errorMessage = "Mot de Passe incorrect, vuillez rééssayer";
